---
title: "Exploration of Female Desert Grassland and Colorado Checkered Lizards"
...
```
Female Colorado Checkered lizards are longer in length than female Desert Grassland lizards. The actual difference in mean length is `r round(CNTE_mean_length - CNUN_mean_length, 1)` mm and the percent difference is `r round((CNTE_mean_length - CNUN_mean_length)/(CNTE_mean_length + CNUN_mean_length)/2*100, 1)`%. In addition, a large effect size was found, Cohen's d = `r round(length_cohen$estimate, 1)`. 
